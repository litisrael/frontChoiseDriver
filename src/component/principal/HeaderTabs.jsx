...
import {
  ...
  ScrollArea,
  Drawer,
  Divider,Center,Box,Collapse,Button
} from '@mantine/core';
...
import { TabItems} from "../kitComponent/TabsItems";
...
export function HeaderTabs() {
  ...
  const itemsBurger = tabs.map((tab) => (
...
<Tabs.Panel value="ONE WAY" pt="xs">
<FormOneWay /> 
</Tabs.Panel>

<Tabs.Panel value="ROUND WAY" pt="xs">
  Settings tab content
</Tabs.Panel>
<Tabs.Panel value= "PRICES OF DRIVER" pt="xs">
  Settings tab content
</Tabs.Panel>
        </Tabs>
      </Container>
